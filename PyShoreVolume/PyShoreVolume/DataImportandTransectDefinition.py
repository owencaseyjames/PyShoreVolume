...
from CleanandTransectLocator.TransectDefinition import transectstartlocator2, transectstartlocator
...
class DataImportandTransectDefinition(): 
    ...
    def __init__(self, CRS, intersects, transects):
        self.CRS = CRS
        self.intersects = intersects
        self.transects = transects

    def transectstartlocator(self):
        self.intersects = transectstartlocator( self.transects, self.intersects)
