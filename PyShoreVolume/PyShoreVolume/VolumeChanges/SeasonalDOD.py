                ...
                ###use the counter to index the mask glob results list [0]
                        if e < num:
                            ...
                            if old.shape == new.shape: 
                                ...
                                plt.yticks(size = 5)
                                plt.show()
                                fig.savefig(save_to_path+'/'+date1+date2+'winter.png')
                                ...
                                #Hist
                                # DODhist = show_hist(lidardem1, bins=10, histtype='stepfilled', lw=0.0, stacked=True, alpha=0.3)
                                # DODhist.savefig(Config.save_to_path+date1+date2+'DOD Histogram.png')
                                # x = np.subtract(imagenewmask, imageoldmask)
