...
def NetVolumeChange():
            """ 
            Applies the pixel size parameter to the elevation models to calulate 
            volumetric changes.
            ...
            lod = np.ma.masked_array(vols, mask=(vols == -9999)|(abs(Config.errors) < vols)&(vols < Config.errors))
...
#             new = new * Config.pixelsize

#             old= np.array(older.read(1, masked = True))
#             old = old * Config.pixelsize
